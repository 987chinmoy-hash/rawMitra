...
export const seedArtisans = [
  { id: 'A-1001', name: 'Deepa Boro', aadhar: '•••• •••• 4821', storeLocation: 'Sualkuchi, Assam', phone: '9864XXXXXX', rating: 4.6, reviews: 12 },
  { id: 'A-1002', name: 'Rukmini Das', aadhar: '•••• •••• 2290', storeLocation: 'Sualkuchi, Assam', phone: '9435XXXXXX', rating: 4.3, reviews: 8 },
  { id: 'A-1003', name: 'Bipul Kalita', aadhar: '•••• •••• 6743', storeLocation: 'Hajo, Assam', phone: '8011XXXXXX', rating: 4.8, reviews: 20 },
  { id: 'A-1004', name: 'Tarun Rabha', aadhar: '•••• •••• 9912', storeLocation: 'Guwahati, Assam', phone: '9706XXXXXX', rating: 4.7, reviews: 14 },
]
...
export const seedCoordinators = [
  { id: 'C-3001', name: 'Manash Sarma', aadhar: '•••• •••• 3345', phone: '9678XXXXXX', experience: '6 years in handloom logistics, ex-Assam Apex Weavers Co-op', rating: 4.7, reviews: 15, activeDeals: 2 },
]
...
export const seedMaterialRequests = [
  ...
  { id: 'R-03', artisanId: 'A-1003', category: 'Bamboo', specification: 'Treated Bhaluka bamboo poles, 10ft', quantity: 25, unit: 'piece', location: 'Guwahati, Assam', requiredDate: '2026-09-18', status: 'open' },
  { id: 'R-04', artisanId: 'A-1004', category: 'Bamboo', specification: 'Treated Bhaluka bamboo poles, 10ft', quantity: 20, unit: 'piece', location: 'Guwahati, Assam', requiredDate: '2026-09-19', status: 'open' },
]

    ...
    <div className="page page-narrow">
      ...
      <form onSubmit={handleSubmit} className="card" noValidate>
        <div className="field">
          ...
          <input id="name" value={form.name} onChange={(e) => update('name', e.target.value)} placeholder="e.g. Deepa Boro" />
        ...
        <div className="field">
          ...
          <input id="loc" value={form.storeLocation} onChange={(e) => update('storeLocation', e.target.value)} placeholder="e.g. Sualkuchi, Assam" />

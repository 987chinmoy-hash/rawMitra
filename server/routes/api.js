...
router.post('/materials/request', requireAuth, requireRole('artisan'), addRequests)
router.delete('/materials/request/:id', requireAuth, withdrawRequest)

// Supplier Catalog & Quotation Management (Supplier)
router.post('/supplier/stock', requireAuth, requireRole('supplier'), addSupplierStock)
router.get('/supplier/my-stock', requireAuth, requireRole('supplier'), getMyStock)

// Order Lifecycle & Penalty Enforcement
router.post('/orders', requireAuth, createOrder)
router.patch('/orders/:id/claim', requireAuth, requireRole('coordinator'), claimDeal)
router.patch('/orders/:id/stage', requireAuth, advanceStage)
...
router.post('/broadcasts', requireAuth, requireRole('artisan'), addBroadcast)
